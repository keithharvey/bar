...
local options = {
	...
	},
	{
		...
		column	= 1.66,
		items	= {
			{ key = "enabled",  name = "Enabled",  desc = "Allied units can perform reclaim commands on allied wrecks" },
			{ key = "disabled", name = "Disabled", desc = "Allied units cannot perform reclaim commands on allied wrecks" },
		},
	},
	{
