...
local options = {
	...
	},
	{
		...
		def		= "all",
		items	= {
			{key = "all", name = "All Units", desc = "Allow sharing of all units and structures"},
			{key = "combat", name = "Combat Only", desc = "Only allow sharing of combat units (no economic units, constructors, or factories)"},
			{key = "disabled", name = "Disabled", desc = "Disable all unit sharing"},
		},
	},
	{
		key		= "game_assist_ally",
		name	= "Ally Construction Assist",
		desc	= "Controls whether players can assist allied construction",
		type	= "list",
		section	= "options_main",
		def		= "enabled",
		column	= 1.76,
		items	= {
			{key = "enabled", name = "Enabled", desc = "Allow assisting allied blueprints and labs"},
			{key = "disabled", name = "Disabled", desc = "Disable assisting allied construction"},
		},
	},
	{
		key		= "unit_market",
