...
-- module-owned fragments; ModuleHandler.ModOptions() takes over when the module loader lands
for _, option in ipairs(VFS.Include("modules/sharing/modoptions.lua")) do
