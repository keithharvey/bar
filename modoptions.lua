...
local options = {
...

	{
		...
		column = 1,
		items = {
			{ key = "default", name = "Default", desc = "Map Settings", lock = { "map_lavatidemode", "map_lavahighlevel", "map_lavahighdwell", "map_lavalowlevel", "map_lavalowdwell", "sub_header_lava3", "sub_header_lava4" }, unlock = { "sub_header_lava1", "sub_header_lava2" } },
			{ key = "enabled", name = "Enable/Override", desc = "Lava tides will use these settings over the map defaults", unlock = { "map_lavatidemode", "map_lavahighlevel", "map_lavahighdwell", "map_lavalowlevel", "map_lavalowdwell", "sub_header_lava3", "sub_header_lava4" }, lock = { "sub_header_lava1", "sub_header_lava2" } },
			{ key = "disabled", name = "Disable", desc = "Lava will not have tides, even on maps that normally have it", lock = { "map_lavatidemode", "map_lavahighlevel", "map_lavahighdwell", "map_lavalowlevel", "map_lavalowdwell", "sub_header_lava3", "sub_header_lava4" }, unlock = { "sub_header_lava1", "sub_header_lava2" } },
		},
		bitmask = 2,
	},
...

	{
		...
		items = {
			...
			{ key = "factory_discount", name = "Enabled: Discounted First Factory", desc = "Quick Start The commander's first factory is discounted at any time. Deducts 400 energy and 800 metal from starting resources.", unlock = { "quick_start_amount" } },
...

	{
		...
		section = "options_experimental",
		items = {
			{ key = "disabled", name = "Disabled", desc = "No community balance changes", lock = { "community_balance_corspy", "community_balance_armmav", "community_balance_corcan", "community_balance_corkarg", "community_balance_armkam", "community_balance_armblade" } },

			{ key = "enabled", name = "Enabled", desc = "Enable all community balance changes\nSpectre\nGunslinger\nSumo\nKarganeth\nBanshee\nHornet", lock = { "community_balance_corspy", "community_balance_armmav", "community_balance_corcan", "community_balance_corkarg", "community_balance_armkam", "community_balance_armblade" } },

			{ key = "custom", name = "Custom", desc = "Customize individual community balance changes", unlock = { "community_balance_corspy", "community_balance_armmav", "community_balance_corcan", "community_balance_corkarg", "community_balance_armkam", "community_balance_armblade" } },
		},
	},
