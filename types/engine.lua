...
-- SpringSynced type surface, vendored from a recoil-lua-library generation off the
...
---`SpringSynced = SpringSynced or Spring` for engines without SetupAliases).
---@class SpringSynced
---@field GetUnitDefs? fun(): table<integer, UnitDef> test-only extension injected by spec builders
SpringSynced = {}

---@return boolean enabled
function SpringSynced.IsCheatingEnabled() end
...
function SpringSynced.GetTeamRulesParam(teamID, ruleRef) end

---@return table<string, string> modOptions Table with options names as keys and values as values.
function SpringSynced.GetModOptions() end

---@return integer teamID
function SpringSynced.GetGaiaTeamID() end

---Get all team IDs.
---
---@param allyTeamID -1|nil (Default: `-1`)
---@return integer[] teamIDs List of team IDs.
function SpringSynced.GetTeamList(allyTeamID) end
...
function SpringSynced.GetTeamInfo(teamID, getTeamKeys) end
...
function SpringSynced.GetTeamResources(teamID, resource) end

---@param teamID integer
---@return string
function SpringSynced.GetTeamLuaAI(teamID) end
...
function SpringSynced.GetPlayerInfo(playerID, getPlayerOpts) end

---@param teamID1 integer
---@param teamID2 integer
---@return boolean?
function SpringSynced.AreTeamsAllied(teamID1, teamID2) end

---@param teamID integer
---@return integer[]? unitIDs
function SpringSynced.GetTeamUnits(teamID) end

---@param unitID integer
---@return integer? teamID nil when the unitID is invalid
function SpringSynced.GetUnitTeam(unitID) end

---@param unitID integer
---@return integer?
function SpringSynced.GetUnitDefID(unitID) end

---@param unitID integer
---@return boolean beingBuilt
---@return number buildProgress
function SpringSynced.GetUnitIsBeingBuilt(unitID) end
...
function SpringSynced.Log(section, logLevel, ...) end
...
---@param amount number
---@return nil
function SpringSynced.AddTeamResource(teamID, type, amount) end

---@param teamID integer
---@param resource ResourceName|StorageName
---@param amount number
---@return nil
function SpringSynced.SetTeamResource(teamID, resource, amount) end
...
---@return nil
function SpringSynced.SetTeamRulesParam(teamID, paramName, paramValue, losAccess) end
...
function SpringSynced.TransferUnit(unitID, newTeamID, given, adjustUnitLimit) end
...
---@param excess number Amount wasted this tick.
---@return nil
function SpringSynced.AddTeamResourceExcessStats(teamID, type, excess) end
