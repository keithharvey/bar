...
---@param springRepo SpringSynced? defaults to Spring (pass a repo to stay testable)
---@return number
function TechBlockingShared.GetTaxRate(teamId, opts, springRepo)
	springRepo = springRepo or (Spring --[[@as SpringSynced]])
...
function TechBlockingShared.AnyTaxConfigured(opts)
	...
	return (tonumber(opts[TAX_KEY]) or 0) > 0 or (tonumber(opts[TAX_KEY .. "_at_t2"]) or 0) > 0 or (tonumber(opts[TAX_KEY .. "_at_t3"]) or 0) > 0
end
