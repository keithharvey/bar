...
function M.sync(doc, ctx, setSummary)
	...
	if WG.TilesetTerrain.getMetalLights then
		...
		if widgetState.tsGlowLast ~= glow then
			...
			if el then
				el:SetAttribute("src", glow and "/luaui/images/terraform_brush/check_on.png" or "/luaui/images/terraform_brush/check_off.png")
			end
		end
	end
	...
	if knobs.albDecouple ~= nil then
		...
		if widgetState.tsAlbDecoupleLast ~= dec then
			...
			if el then
				el:SetAttribute("src", dec and "/luaui/images/terraform_brush/check_on.png" or "/luaui/images/terraform_brush/check_off.png")
			end
		end
	end
