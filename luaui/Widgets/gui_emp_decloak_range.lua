...
for udid, ud in pairs(UnitDefs) do
	...
	if name:find("armgremlin") or name:find("armamb") or name:find("armpb") or name:find("armferret") or name:find("armckfus") or name:find("armsnipe") or name:find("armshockwave") or name:find("eyes") or name:find("mine") or name:find("armcom") or name:find("corcom") or name:find("legcom") or name:find("corsktl") then
...
function widget:DrawWorldPreUnit()
	...
	for unitID, prop in pairs(units) do
		...
		if ((not onlyDrawRangeWhenSelected) or spIsUnitSelected(unitID)) and spIsSphereInView(dx, dy, dz, maxRad) then
