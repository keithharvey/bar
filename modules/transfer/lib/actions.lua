...
Actions.Assist = { Allied = { domain = "assist" } }
Actions.Reclaim = { AlliedUnits = { domain = "reclaim" } }
Actions.Resurrect = { Partial = { domain = "resurrect" } }
Actions.Build = { Constructors = { domain = "build" } }
