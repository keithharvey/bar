...
function Shared.GetCachedPolicyResult(senderTeamId, receiverTeamId, springApi)
	...
	local senderFactor = Shared.UnitFactor.Read(spring, senderTeamId)
	local receiverFactor = Shared.UnitFactor.Read(spring, receiverTeamId)
	...
	local modes = senderFactor.sharingModes or { ConstructionEnums.UnitFilterCategory.None }
