...
---@field MexSplitting fun(which: MexSplittingKey): TransferModeChain Where a team's mex income comes from: writes mex_splitting with the given key. A rule verb, so it comes back pinned.
