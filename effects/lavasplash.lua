...
definitions["lavasplash-large"] = {
	...
	lavachunks = lavachunks(8, 2.5, 16, [[2 i0.2]], 1.5, 13, 13, [[-70 r140, -0.4 r0.8, -180 r360]]),
}
...
definitions["lavasplash-huge"] = {
	...
	lavarush = lavarush(2, 1, [[10 r20]], 21, [[4.8 i1.2]], 0, 32, 53, nil, [[r0.08, 1, r0.08]]),
	embers = lavaembers(16, 6, 19, 1.3, 8, 18, 25),
	lavachunks = lavachunks(8, 2.7, 17, [[2.8 i0.2]], 1.5, 17, 15, [[-70 r140, -0.4 r0.8, -180 r360]]),
}
...
definitions["lavasplash-gigantic"] = {
	...
	lavarush = lavarush(2, 2, [[28 r48]], 68, [[10.5 i0.7]], 6, 35, 56, [[-70 r140, 70 r35, -70 r140]], [[r0.1, 0.7, r0.1]]),
	lavasmoke = lavasmoke(1, [[15 r23]], 1.7, [[44 r55]], [[28 r14]], [[-17 r34, -7 r14, 0 r65]]),
	embers = lavaembers(6, 20, 25, 5.6, 11, 45, 38),
	lavachunks = lavachunks(8, 15, 38, [[4.2 i0.7]], 5, 35, 29, [[-70 r140, -7 r14, -180 r360]]),
...
definitions["lavasplash-nuke"] = {
	...
	lavarush = lavarush(3, 2, [[66 r84]], 84, [[13 i0.7]], 7, 70, 84, [[-91 r182, 77 r42, -91 r182]], [[r0.1, 0.7, r0.1]]),
	lavasmoke = lavasmoke(2, [[24 r38]], 1.9, [[62 r78]], [[38 r18]], [[-35 r70, -7 r14, 0 r65]]),
	embers = lavaembers(18, 24, 27, 9, 17, 56, 45),
	lavachunks = lavachunks(14, 30, 63, [[5.6 i0.7]], 5.6, 63, 28, [[-35 r70, -5 r10, -180 r360]]),
...
definitions["lavasplash-nukexl"] = {
	...
	lavarush = lavarush(3, 2, [[84 r98]], 98, [[18 i0.7]], 10, 70, 98, [[-91 r182, 77 r42, -91 r182]], [[r0.1, 0.7, r0.1]]),
	lavasmoke = lavasmoke(3, [[28 r48]], 2.1, [[72 r96]], [[46 r23]], [[-35 r70, -7 r14, 0 r65]]),
	embers = lavaembers(18, 56, 56, 12, 18, 63, 45),
	lavachunks = lavachunks(17, 42, 105, [[7.7 i1.4]], 7, 77, 31, [[-35 r70, -5 r10, -180 r360]]),
